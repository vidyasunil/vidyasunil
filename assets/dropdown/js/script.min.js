		...
		return e.prototype.eq = function(t) {
			...
			return t(this).each(function() {
				...
				if (o.is(":root"))
					...
					if (!o.is(":toggle"))
						return s = t(this).parent().find(">" + l.DROPDOWN_MENU)
				}
			...
			if (r) {
				...
				if ("A" == e.target.tagName) {
					...
					if (i.prop(":flat", d._isCollapsed(i.root())), i.is(":flat"))
						...
						e.which === a.LEFT || e.which === a.RIGHT ? (i[e.which===a.LEFT?"prev":"next"]().focus().open(), i.is(":toggle") && i.close()) : e.which !== a.DOWN && e.which !== a.UP || !i.is(":toggle") || i.children()[e.which===a.DOWN?"first":"last"]().focus()
